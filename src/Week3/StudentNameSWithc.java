...
public class StudentNameSWithc {

	public static void main(String[] args) {
		//Write a program using the switch statement

		//Let us consider there are three students in the class with 
		//roll number starting from (101 to 103) if any number other than 101-103 are present display "Not found Student name: in Class"
		...
		switch(rollNum) {
		case 101:
			System.out.println("Student name is Ramish");
			break;
		case 102:
			System.out.println("Student name is Mahesh");
			break;
		case 103:
			System.out.println("Student name is Mukesh");
			break;
		default:
			System.out.println("Student name not exict here ");
			break;
		}
